<template>
  <div class="font-display">
    ...
    <div class="py-12 px-10 container mx-auto font-display">
      ...
      <h2 class="font-semibold">PERSONAL INFORMATION WE COLLECT</h2>
      <br />
      <br />
      ...
      browse the Site, along with basic user-demographic such as general
      location, age range, and gender, as is provided by connected social media
      websites. When we talk about “Personal Information” in this Privacy
      ...
      – Do market research to improve our shipping/RMA centers. We use the
      Device Information that we collect to help us screen for potential risk
      and fraud (in particular, your IP address), and more generally to improve
      and optimize our Site (for example, by generating analytics about how our
      customers browse and interact with the Site, and to assess the success of
      ...
      <p>
        ...
        to help us understand how our customers use the Site — you can read more
      ...
      <p>
        ...
        practices when we see a Do Not Track signal from your browser. Please
        note that your information may be transferred outside of Bangladesh.
      </p>
      <br />
      <br />DATA RETENTION
      <p>
      ...
      <br />CHANGES We may update this privacy policy from time to time in order
